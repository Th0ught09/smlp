...
class ModelSklearn:
    def __init__(self):
        ...
        self._trees_hyperparam_dict = {
            "criterion": {
                ...
                + "[default: "
                + str(self._DEF_CRITERION)
                + "]",
            },
            "max_depth": {
                "abbr": "max_depth",
                "default": self._DEF_MAX_DEPTH,
                "type": int,
                "help": "The maximum depth of the tree. If None, then nodes are expanded until all "
                + "leaves are pure or until all leaves contain less than min_samples_split samples. "
                + "[default: "
                + str(self._DEF_MAX_DEPTH)
                + "]",
            },
            "min_samples_split": {
                "abbr": "min_samples_split",
                "default": self._DEF_MIN_SAMPLES_SPLIT,
                "type": str,  # can be int or float
                ...
                + "[default: "
                + str(self._DEF_MIN_SAMPLES_SPLIT)
                + "]",
            },
            "min_samples_leaf": {
                "abbr": "min_samples_leaf",
                "default": self._DEF_MIN_SAMPLES_LEAF,
                "type": str,  # can be int or float
                ...
                + " [default: "
                + str(self._DEF_MIN_SAMPLES_LEAF)
                + "]",
            },
            "min_weight_fraction_leaf": {
                "abbr": "min_weight_fraction_leaf",
                "default": self._DEF_MIN_WEIGHT_FRACTION_LEAF,
                "type": float,
                "help": "The minimum weighted fraction of the sum total of weights "
                + "(of all the input samples) required to be at a leaf node. "
                + "Samples have equal weight when sample_weight is not provided. "
                + " [default: "
                + str(self._DEF_MIN_WEIGHT_FRACTION_LEAF)
                + "]",
            },
            "max_leaf_nodes": {
                "abbr": "max_leaf_nodes",
                "default": self._DEF_MAX_LEAF_NODES,
                "type": int,
                ...
                + "number of leaf nodes [default: "
                + str(self._DEF_MAX_LEAF_NODES)
                + "]",
            },
            "min_impurity_decrease": {
                "abbr": "min_impurity_decrease",
                "default": self._DEF_MIN_IMPURITY_DECREASE,
                "type": float,
                ...
                + "if sample_weight is passed. [default: "
                + str(self._DEF_MIN_IMPURITY_DECREASE)
                + "]",
            },
            "ccp_alpha": {
                "abbr": "ccp_alpha",
                "default": self._DEF_CCP_ALPHA,
                "type": float,
                ...
                + "By default, no pruning is performed. [default: "
                + str(self._DEF_CCP_ALPHA)
                + "]",
            },
        }
        ...
        self._dt_hyperparam_dict = {
            "splitter": {
                ...
                + "[default: "
                + str(self._DEF_SPLITTER_RF)
                + "]",
            },
            "max_features": {
                "abbr": "max_features",
                "default": self._DEF_MAX_FEATURS_DT,
                "type": str,  # can be int, float or constant string
                ...
                + "If None, then max_features=n_features. [default: "
                + str(self._DEF_MAX_FEATURS_DT)
                + "]",
            },
            "random_state": {
                "abbr": "rand_state",
                "default": self._DEF_RAND_STATE,
                "type": int,
                ...
                + "has to be fixed to an integer. [default: "
                + str(self._DEF_RAND_STATE)
                + "]",
            },
        }
        ...
        self._rf_hyperparam_dict = {
            "n_estimators": {
                "abbr": "n_estimators",
                "default": self._DEF_N_ESTIMATORS,
                "type": int,
                "help": "The number of trees in the forest. [default: "
                + str(self._DEF_N_ESTIMATORS)
                + "]",
            },
            "max_features": {
                "abbr": "max_features",
                "default": self._DEF_MAX_FEATURS_RF,
                "type": str,  # can be int, float or constant string
                "help": "The number of features to consider when looking for the best split: "
                + "If int, then consider max_features features at each split. "
                + "If float, max_features is a fraction and max(1, int(max_features * n_features_in_)) "
                ...
                + "If “sqrt”, then max_features=sqrt(n_features). "
                + "If “log2”, then max_features=log2(n_features). "
                + "If None or 1.0, then max_features=n_features. [default: "
                + str(self._DEF_MAX_FEATURS_RF)
                + "]",
            },
            "bootstrap": {
                "abbr": "bootstrap",
                "default": self._DEF_BOOTSTRAP,
                "type": str_to_bool,
                "help": "Whether bootstrap samples are used when building trees. If False, the whole "
                + "dataset is used to build each tree [default: "
                + str(self._DEF_BOOTSTRAP)
                + "]",
            },
            "verbose": {
                "abbr": "verbose",
                "default": self._DEF_VERBOSE_RF,
                "type": str_to_bool,
                "help": "Controls the verbosity when fitting and predicting. [default: "
                + str(self._DEF_VERBOSE_RF)
                + "]",
            },
            "warm_start": {
                "abbr": "warm_start",
                "default": self._DEF_WARM_START,
                "type": str_to_bool,
                ...
                + "[default: "
                + str(self._DEF_WARM_START)
                + "]",
            },
            "max_samples": {
                "abbr": "max_samples",
                "default": self._DEF_MAX_SAMPLES,
                "type": str,
        ...
        self._et_hyperparam_dict = {
            ...
            "max_features": {
                "abbr": "max_features",
                "default": self._DEF_MAX_FEATURS_ET,
                "type": str,  # can be int, float or constant string
                "help": "The number of features to consider when looking for the best split: "
                + "If int, then consider max_features features at each split. "
                + "If float, max_features is a fraction and max(1, int(max_features * n_features_in_)) "
        ...
        self._poly_hyperparam_dict = {
            "degree": {
                "abbr": "degree",
                "default": self._DEF_POLY_DEGREE,
                "type": int,
                "help": "Degree of the polynomial to train [default: "
                + str(self._DEF_POLY_DEGREE)
                + "]",
            },
            "fit_intercept": {
                "abbr": "fit_intercept",
                "default": self._DEF_FIT_INTERCEPT,
                "type": str_to_bool,
                ...
                + "[default: "
                + str(self._DEF_FIT_INTERCEPT)
                + "]",
            },
            "copy_X": {
                "abbr": "copy_X",
                "default": self._DEF_COPY_X,
                "type": str_to_bool,
                "help": "If True, X will be copied; else, it may be overwritten. [default: "
                + str(self._DEF_COPY_X)
                + "]",
            },
            "n_jobs": {
                "abbr": "n_jobs",
                "default": self._DEF_N_JOBS,
                "type": int,
    ...
    def _hparam_dict_global_to_local(self, algo, hparam_dict):
        return dict(
            [
                (self._hparam_name_global_to_local(algo, k), v)
                for (k, v) in hparam_dict.items()
                if self._hparam_name_global_to_local(algo, k) is not None
            ]
        )
    ...
    def get_sklearn_hparam_default_dict(self):
        dt_sklearn_hyperparam_dict = self._param_dict_with_algo_name(
            self._dt_hyperparam_dict | self._trees_hyperparam_dict, "dt"
        )
        rf_sklearn_hyperparam_dict = self._param_dict_with_algo_name(
            self._rf_hyperparam_dict | self._trees_hyperparam_dict, "rf"
        )
        et_sklearn_hyperparam_dict = self._param_dict_with_algo_name(
            self._et_hyperparam_dict | self._trees_hyperparam_dict, "et"
        )
        poly_sklearn_hyperparam_dict = self._param_dict_with_algo_name(
            self._poly_hyperparam_dict, "poly"
        )
        sklearn_hparam_dict = (
            poly_sklearn_hyperparam_dict
            | dt_sklearn_hyperparam_dict
            | rf_sklearn_hyperparam_dict
            | et_sklearn_hyperparam_dict
        )
    ...
    def df_cols_summary(self, df):
        for col in df.columns.tolist():
            print(
                ...
                df[col].std(),
                "z_min",
                (df[col].min() - df[col].mean()) / df[col].std(),
                "z_max",
                (df[col].max() - df[col].mean()) / df[col].std(),
            )
    ...
    def _sklearn_train_multi_response(
        self,
        get_model_file_prefix,
        feat_names,
        resp_names,
        algo,
        X_train,
        ...
        if algo in ["dt", "et", "rf"]:
            ...
            rules_report_file_suffix = (
                "tree_rules.txt"
                if len(resp_names) != 1
                else "_".join([resp_names[0], "tree_rules.txt"])
            )
            rules_report_file = "_".join(
                [
                    get_model_file_prefix(None, self._algo_name_local2global(algo)),
                    rules_report_file_suffix,
                ]
            )
            self._instTreeTerms.trees_to_rules(
                tree_estimators, feat_names, resp_names, None, True, rules_report_file
            )
            return model
        elif algo == "poly":
            linear_model, poly_reg = self.poly_train(
                feat_names,
                resp_names,
                hparam_dict,
                X_train,
            ...
            for resp_id in range(len(resp_names)):
                ...
                model_formula = self._instPolyTerms.poly_model_to_term_single_response(
                    feat_names,
                    resp_names,
                    linear_model.coef_,
                    poly_reg.powers_,
            ...
            raise Exception(
                "Unsupported model type " + str(algo) + " in function tree_main"
            )
    ...
    def sklearn_main(
        ...
        if model_per_response:
            ...
            for rn in resp_names:
                rn_model = self._sklearn_train_multi_response(
                    get_model_file_prefix,
                    feat_names_dict[rn],
                    [rn],
                    algo,
                    X_train[feat_names_dict[rn]],
                    X_test[feat_names_dict[rn]],
                    y_train[[rn]],
                    y_test[[rn]],
                    hparam_dict,
                    interactive_plots,
            ...
            union_feat_names = lists_union_order_preserving_without_duplicates(
                list(feat_names_dict.values())
            )
            model = self._sklearn_train_multi_response(
                get_model_file_prefix,
                union_feat_names,
                resp_names,
                algo,
