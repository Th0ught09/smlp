...
class SmlpConfig:
    def __init__(self):
        ...
        self.config_params_dict = {
            "labeled_data": {
                "abbr": "data",
                "default": self._DEF_LABELED_DATA,
                "type": str,
                "help": "Path, possibly excluding the .csv, or including gz or bz2 suffix, to input "
                + " training data file containing labels [default {}]".format(
                    str(self._DEF_LABELED_DATA)
                ),
            },
            "analytics_mode": {
                "abbr": "mode",
                "default": self._DEF_ANALYTICS_MODE,
                "type": str,
            ...
            "interactive_plots": {
                "abbr": "plots",
                "default": self._DEF_INTERACTIVE_PLOTS,
                "type": str_to_bool,
            ...
            "output_directory": {
                "abbr": "out_dir",
                "default": self._DEF_OUTPUT_DIRECTORY,
                "type": str,
            ...
            "save_configuration": {
                "abbr": "save_config",
                "default": self._DEF_SAVE_CONFIGURATION,
                "type": str_to_bool,
            ...
            "load_configuration": {
                "abbr": "config",
                "default": self._DEF_LOAD_CONFIGURATION,
                "type": str,
    ...
    def args_get_report_name_prefix(
        self,
        data_file_prefix: str,
        run_prefix: str,
        output_directory: str = None,
        new_data_file_prefix: str = None,
        model_name: str = None,
        ...
        if out_dir is None:
            if not data_dir is None:
                ...
                raise Exception(
                    "A training data file, a model or doe spec file should be provided"
                )
        ...
        if model_name is None:
            ...
            model_name_prefix = os.path.join(
                out_dir, run_prefix + "_" + input_data_name_prefix
            )
        else:
        ...
        if input_data_name_prefix is None:
            ...
            report_name_prefix = os.path.join(
                out_dir, run_prefix + "_" + input_data_name_prefix
            )
    ...
    def args_dict_parse(self, argv, args_dict):
        ...
        parser.add_argument("-dra", "--dimension-reduction-amount", type=int)
        ...
        self.report_file_prefix, self.model_file_prefix = (
            self.args_get_report_name_prefix(
                args.labeled_data,
                args.log_files_prefix,
